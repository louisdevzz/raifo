            ...
            <div className="w-full">    
                ...
                <div className="mt-5 md:px-3">
                    ...
                    <div className="mt-5">
                        ...
                        <div className="mt-3 md:mt-0 flex md:flex-row flex-col-reverse items-start md:items-center">
                            <div className="mt-3 md:mt-0 md:mr-[300px]">
                        ...
                        <div className="mt-3 md:mt-5 flex md:flex-row flex-col-reverse items-start md:items-center">
                            <div className="mt-3 md:mt-0 md:mr-[310px]">
                                <div className="text-sm flex flex-row">
                                    <p>Chuyên viên: &nbsp;</p>
                        ...
                        <div className="mt-3 md:mt-5 flex md:flex-row flex-col-reverse items-start md:items-center">
                            ...
                            <div className="border border-gray-300 md:ml-[292px]">
                        ...
                        <div className="mt-3 md:mt-5 flex md:flex-row flex-col-reverse items-start md:items-center">
                            ...
                            <div className="border border-gray-300 md:ml-[260px]">
                                <img src="https://img.freepik.com/free-photo/abstract-surface-textures-white-concrete-stone-wall_74190-8189.jpg?size=626&ext=jpg&ga=GA1.1.1224184972.1713484800&semt=ais" className="w-[153px] h-[110px]"/>
                            </div>
                        </div>
                    </div>
