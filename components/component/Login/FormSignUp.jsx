            ...
            <div className="flex items-center justify-end">
                <div className="flex flex-col w-full sm:w-auto sm:flex-row p-4 mt-12">
                    <button onClick={()=>setIsCreate(false)}
                        className="flex items-center justify-center w-full px-4 py-4 text-sm font-bold leading-6 capitalize duration-100 transform border-2 rounded-sm cursor-pointer border-[#1a5fb4] focus:ring-4 focus:ring-opacity-50 focus:outline-none sm:w-auto sm:px-6 sm:mr-4 border-text  hover:shadow-lg hover:-translate-y-1">
                        Đăng nhập
                    </button>
                    <button onClick={handleCreateUser} className="flex flex-row items-center justify-center w-full px-4 py-4 mb-4 text-sm font-bold bg-[#1a5fb4] leading-6 capitalize duration-100 transform rounded-sm shadow cursor-pointer focus:ring-4 focus:ring-opacity-50 focus:outline-none sm:mb-0 sm:w-auto md:pl-8 md:pr-6 xl:pl-5 xl:pr-5  hover:shadow-lg hover:-translate-y-1">
                        Đăng ký
                        <span className="ml-4">
