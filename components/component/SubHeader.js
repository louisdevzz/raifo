...
const DropDownMenu = ({title,children}) =>{
    return(
        <div className='duration-500 transition-all'>
            ...
            <div className='absolute w-[160px] invisible group-hover:visible border-t-4 bg-white drop-shadow-xl border-[#183762]  text-sm leading-loose'>
    ...
    return(
        <div className='duration-500 transition-all'>
            <div className='group/item'>
                <div className='cursor-pointer py-2 hover:bg-[#183762] hover:text-white relative px-1'>{title}</div>
                <div className='absolute w-[250px] translate-x-[160px] -translate-y-[48px] invisible group-hover/item:visible border-t-4 bg-white drop-shadow-xl border-[#183762]  text-sm leading-loose'>
                    <ul className='z-10'>
                        {children.map((dt)=>(
